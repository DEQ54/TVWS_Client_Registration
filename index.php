...
else
{
	...
	$.ajax({
		...
		method:'post',
		dataType: 'json',
		data:{"rulesetIDs":[{ "authority":"57c8e0e9-dbf9-314a-b985-ea431ec6b6f6","rulesetId":"57c8e0e9-dbf9-314a-b985-ea431ec6b6f6"}],"deviceDesc":{"username":$("#username").val(),"serialNumber": $("#serialnumber").val(),"modelId":$("#modelid").val(),"manufacturerId":$("#manufacturerid").val(),"longitude":$("#longitude").val(),"latitude":$("#latitude").val(),"deviceType":$("#devicetype").val(),"phoneNumber":$("#phone").val(),"region":$("#region").val(),"district":$("#district").val(),"transmitter_power":$("#transmitterpower").val(),"operator":$("#operator").val(),"antennaheight":$("#antennaheight").val(),"antennaheighttype":$("#antennaheighttype").val()},"key":"client"},
